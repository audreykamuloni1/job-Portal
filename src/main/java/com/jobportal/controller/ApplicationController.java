...
import com.jobportal.exception.ResourceNotFoundException; // Added import
...
public class ApplicationController {
    ...
    @PreAuthorize("hasAuthority('ROLE_EMPLOYER')")
    public ResponseEntity<List<RecentApplicationDTO>> getRecentApplicationsForEmployer(
            @AuthenticationPrincipal UserDetails userDetails,
        ...
        List<RecentApplicationDTO> recentApps = applicationService.getRecentApplicationsByEmployer(employer.getId(), limit);
